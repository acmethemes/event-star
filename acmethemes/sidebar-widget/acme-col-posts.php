    ...
    class Event_Star_Posts_Col extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'event_star_widget_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'event_star_widget_title' ) ); ?>" type="text" value="<?php echo esc_attr( $event_star_widget_title ); ?>" />
            </p>
            <p>
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'event_star_img_size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'event_star_img_size' ) ); ?>">
			        ...
			        foreach( $event_star_image_sizes as $key => $event_star_column_array ){
				        echo ' <option value="'.esc_attr( $key ).'" '.selected( esc_attr( $event_star_img_size ), $key, 0). '>'.esc_html( $event_star_column_array ).'</option>';
			        }
			        ?>
                </select>
            </p>
                ...
                <section id="<?php echo esc_attr( $unique_id ); ?>" class="at-widgets acme-col-posts <?php echo $bg_gray_class;?>">
                    <div class="container">
                        ...
                        if ( !empty( $event_star_widget_title ) ){
                            ...
                            echo esc_html( $event_star_widget_title );
