...
if ( ! class_exists( 'Event_Star_Event' ) ) {
	...
	class Event_Star_Event extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'event_title' ) ); ?>"><?php esc_html_e( 'Event Title', 'event-star' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'event_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'event_title' ) ); ?>" type="text" value="<?php echo esc_attr( $event_title ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'event_date' ) ); ?>"><?php esc_html_e( 'Event Date', 'event-star' ); ?></label>
				<input class="widefat at-date-picker" id="<?php echo esc_attr( $this->get_field_id( 'event_date' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'event_date' ) ); ?>" type="text" value="<?php echo esc_attr( $event_date ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_one_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'event-star' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'button_one_text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'button_one_text' ) ); ?>" type="text" value="<?php echo esc_html( $button_one_text ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_one_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'event-star' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_two_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'event-star' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'button_two_text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'button_two_text' ) ); ?>" type="text" value="<?php echo esc_html( $button_two_text ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_two_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'event-star' ); ?></label>
		...
		public function widget( $args, $instance ) {
			...
			?>
			<section id="<?php echo $unique_id; ?>" class="at-widgets at-event-count-down" style="background: <?php echo esc_attr( $event_star_primary_color ); ?>">
				<div class="container">
					<?php
					if ( ! empty( $title ) ) {
					...
					?>
					<div class="row">
						<div class="col-md-3 text-left <?php echo esc_attr( $animation1 ); ?>">
							<?php
						...
						<div class="col-md-6">
							...
							if ( ! empty( $event_date ) ) {
								...
								if ( ! empty( $date_time ) && is_array( $date_time ) ) {
									...
									>
										<div class="feature-col col-xs-3 <?php echo esc_attr( $animation1 ); ?>">
						...
						<div class="col-md-3 text-right at-btn-wrap <?php echo esc_attr( $animation1 ); ?>">
							<?php
