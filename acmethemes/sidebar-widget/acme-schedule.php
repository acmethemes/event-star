...
if ( ! class_exists( 'Event_Star_Schedule' ) ) {
    ...
    class Event_Star_Schedule extends WP_Widget {
        ...
        public function form( $instance ) {
                    ...
                    <div class="repeater-table">
                        ...
                        <div class='at-repeater-inside hidden'>
                            <p>
                                ...
                                <input id="<?php echo esc_attr( $tab_title_id ); ?>" name="<?php echo esc_attr( $tab_title_name ); ?>" type="text"/>
                            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_text' ) ); ?>"><?php esc_html_e( 'Read More Text', 'event-star' ); ?></label>
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="at-widgets at-schedule <?php echo esc_attr( $bg_gray_class ); ?>">
                <div class="container">
	                <?php
	                if( !empty( $title ) ) {
                        ...
                        if( !empty( $post_in ) ):
                            ...
                            if ( $schedule_query->have_posts() ):
	                            ...
	                            while( $schedule_query->have_posts() ):$schedule_query->the_post();
		                            ...
		                            ?>
                                    <div class="schedule-title <?php echo esc_attr( $active ); ?>">
